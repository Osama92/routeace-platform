...
export default function Press() {
  return (
    <PublicShell title="Press" description="RouteAce press kit, brand assets, and recent coverage." canonical="https://routeace.app/press">
      ...
      <Card className="p-5 space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Email <a className="text-primary underline" href="mailto:press@routeace.app">press@routeace.app</a> and we'll send the full kit (logos, product shots, founder photos, fact sheet) within 24 hours.</p>
      </Card>
      <Card className="p-5 space-y-2">
