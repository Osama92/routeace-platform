...
import { Search, Filter, Clock, User, FileText, Eye, ShieldX } from "lucide-react";
...
const actionColors: Record<string, string> = {
  ...
  access_denied: "bg-destructive/15 text-destructive border border-destructive/30",
};
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { label: "Access Denied", value: logs.filter(l => l.action === "access_denied").length, icon: ShieldX },
        ].map((stat, index) => (
          <motion.div
            key={stat.label}
