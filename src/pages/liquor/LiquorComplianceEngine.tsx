  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Compliance Verification Engine</h1>
          <p className="text-muted-foreground">Age verification, license management, delivery restrictions, and audit trail</p>
        </div>
      </div>
