  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Transaction Ledger</h1>
          <p className="text-muted-foreground">Complete audit trail of all commerce activity across the exchange</p>
        </div>
      </div>
