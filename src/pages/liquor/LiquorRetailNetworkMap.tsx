  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Retail Network Map</h1>
          <p className="text-muted-foreground">Connected commerce graph of the alcohol distribution ecosystem</p>
        </div>
      </div>
