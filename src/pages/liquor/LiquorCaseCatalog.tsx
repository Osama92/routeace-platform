  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Case Catalog</h1>
          <p className="text-muted-foreground">Beverage portfolio with case pricing & velocity metrics</p>
        </div>
      </div>
