  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Outlet Lookalike Discovery</h1>
          <p className="text-muted-foreground">AI identifies high-potential outlets similar to your top performers</p>
        </div>
      </div>
