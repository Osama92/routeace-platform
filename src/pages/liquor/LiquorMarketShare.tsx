  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Market Share Intelligence</h1>
          <p className="text-muted-foreground">Brand share estimation across cities, districts, and retail categories</p>
        </div>
      </div>
