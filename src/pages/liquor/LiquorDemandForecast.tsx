  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Demand Forecasting Engine</h1>
          <p className="text-muted-foreground">AI-powered demand predictions, automated restocking & seasonal intelligence</p>
        </div>
      </div>
