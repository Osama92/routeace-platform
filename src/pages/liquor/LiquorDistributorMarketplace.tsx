  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Distributor Inventory Marketplace</h1>
          <p className="text-muted-foreground">Real-time inventory from distributors - browse, order, schedule delivery</p>
        </div>
      </div>
