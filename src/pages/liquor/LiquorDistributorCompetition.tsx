  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Distributor Competition Intelligence</h1>
          <p className="text-muted-foreground">Benchmark distributor performance across territory, sales, and compliance metrics</p>
        </div>
      </div>
