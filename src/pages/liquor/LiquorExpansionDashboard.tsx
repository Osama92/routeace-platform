  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Global Expansion Engine</h1>
          <p className="text-muted-foreground">Strategic AI system for Nigerian alcohol market expansion decisions</p>
        </div>
      </div>
