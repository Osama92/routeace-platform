  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Account Scoring & Health</h1>
          <p className="text-muted-foreground">AI-powered retailer scoring, predicted reorders & upsell signals</p>
        </div>
      </div>
