  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Smart Order Routing Engine</h1>
          <p className="text-muted-foreground">Automatic distributor assignment, warehouse selection, and route optimization</p>
        </div>
      </div>
