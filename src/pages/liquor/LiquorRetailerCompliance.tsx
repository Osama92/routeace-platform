  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Retailer Compliance Dashboard</h1>
          <p className="text-muted-foreground">License status, expiry alerts & compliance checklist</p>
        </div>
      </div>
