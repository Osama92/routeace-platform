  ...
  <IndustryLayout industryCode="liquor">
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Trade Promotion Exchange</h1>
          <p className="text-muted-foreground">Supplier-funded promotions distributed across the network with real-time ROI</p>
        </div>
      </div>
