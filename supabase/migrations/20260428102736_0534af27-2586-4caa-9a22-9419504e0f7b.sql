...
ALTER TABLE public.profiles DISABLE TRIGGER trg_protect_profile_sensitive_fields;
...
ALTER TABLE public.profiles ENABLE TRIGGER trg_protect_profile_sensitive_fields;
